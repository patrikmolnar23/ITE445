...
Ball.Preloader.prototype = {
	preload: function() {
		...
		this.load.image('ball', 'img/ball1.png');
		...
		this.load.image('title', 'img/title1.png');
		this.load.image('button-pause', 'img/button-pause.png');
		this.load.image('screen-bg', 'img/screen-bg.png');
		this.load.image('screen-mainmenu', 'img/screen-mainmenu1.png');
		...
		this.load.image('powerup-plus', 'img/powerupPlus.png');
		this.load.image('powerup-minus', 'img/powerupMinus.png');
		this.load.image('bullet','img/bullet.png');

		this.load.spritesheet('button-audio', 'img/button-audio.png', 35, 35);
		this.load.spritesheet('button-start', 'img/button-start.png', 146, 51);
		//this.load.spritesheet('enemy', 'img/enemy.png', 64,64,4);
