...
Ball.Game.prototype = {
	create: function() {
		...
		this.healthText = this.game.add.text(15,60, "Health: "+this.health,this.fontSmall);
		...
		this.powerup = this.add.sprite(posX,posY,'powerup-plus');
		this.physics.enable(this.powerup, Phaser.Physics.ARCADE);
		this.powerup.anchor.set(0.8);
		this.powerup.body.setSize(10,10);

		var posX1 = Math.random() * 300;
		var posY1 = Math.random() * 400;
		this.powerdown = this.add.sprite(posX1,posY1,'powerup-minus');
		this.physics.enable(this.powerdown, Phaser.Physics.ARCADE);
		this.powerdown.anchor.set(0.8);
		this.powerdown.body.setSize(10,10);
		...
		//this.bullet = this.add.sprite(0, 200, 'bullet');
	//	this.physics.enable(this.bullet, Phaser.Physics.ARCADE);
		...
		//var enemy = this.add.sprite(250, 200, 'enemy');
	...
	initLevels: function() {
		...
		for(var i=0; i<this.maxLevels; i++) {
			...
			//this.bullet.y =  this.rnd.integerInRange(100, 200);
		}
	},
	...
	update: function() {
		...
		this.physics.arcade.overlap(this.ball, this.powerup, this.increase, null, this);
		this.physics.arcade.overlap(this.ball, this.powerdown, this.decrease, null, this);
		this.physics.arcade.collide(this.ball, this.wallCollision, this.lessHealth, null, this);
	...
	finishLevel: function() {
		if(this.level >= this.maxLevels) {
			...
			this.powerup = this.add.sprite(40,120,'powerup-plus');
			this.physics.enable(this.powerup, Phaser.Physics.ARCADE);
			this.powerup.anchor.set(0.8);
			this.powerup.body.setSize(10,10);

			this.powerdown = this.add.sprite(100,300,'powerup-minus');
			this.physics.enable(this.powerdown, Phaser.Physics.ARCADE);
			this.powerdown.anchor.set(0.8);
			this.powerdown.body.setSize(10,10);
